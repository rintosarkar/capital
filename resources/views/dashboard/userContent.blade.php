 	        ...
 	        <div class="panel deep-purple-box">
 	            <div class="panel-body">
 	            	<div class="panel-head">
 	            		{{-- <p class="text-center h3">Today's Top Earner</p>  --}}
 	            	</div>
 	                <div class="row">
 	                    <div class="col-md-5 col-sm-5 col-xs-5">
 	                        <div class="top-earner">Today's top Earner</div>
 	                    </div>
...
<script type="text/javascript" src="js/vticker/vticker.js"></script>
<script type="text/javascript">

// Scripts for newsticker on today's top earner
